...
class Exporter(NodeBase):
    ...
    def __init__(self, archive_fn, img_facettes, prop_facettes):
        self.archive_fn = archive_fn
        self.img_facettes = img_facettes
        self.prop_facettes = prop_facettes
    ...
    def __call__(self, input=None):
        with ZipFile(self.archive_fn, 'w', zipfile.ZIP_DEFLATED) as myzip:
            ...
            for data_object in input:
                ...
                self.export_properties(data_object)
                self.export_images(data_object)

    def export_properties(self, data_object):
        # export the properties specified in prop_facettes

    def export_images(self, data_object):
        # export the images specified in img_facettes
